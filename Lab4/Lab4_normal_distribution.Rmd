...
low calorie options, as indicated by the highest bar being earlier, and
less, or none, extremely high calorie options. The distribution appears
to be relatively normal by both restaurants other than some extreme
outliers in the McDonald's menu.
...
The Dairy Queen sodium probabilities were a lot closer aligned than than
the McDonald probabilities. This implies that the Dairy Queen sodium
amounts is more evenly distributed that McDonalds. However, since we
were dealing with the upper boundaries of the distributions we are more
prone to outliers having a larger impact. This is particularly true in
the case of Dairy Queen.
